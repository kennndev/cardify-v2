...
import { ShoppingCart, Sparkles, Upload, Store, ChevronDown, Coins, User, LogOut, LogIn } from "lucide-react"
...
export function Navigation() {
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      ...
      if (typeof ce.detail?.credits === "number") setCredits(ce.detail.credits)
    }
